...
//added by sena
bool compareRed( const colorNameMapping& s1, const colorNameMapping& s2 ) {
    return s1.color.r < s2.color.r;
}

bool compareGreen( const colorNameMapping& s1, const colorNameMapping& s2 ) {
    return s1.color.g < s2.color.g;
}

bool compareBlue( const colorNameMapping& s1, const colorNameMapping& s2 ) {
    return s1.color.b < s2.color.b;
}
//--------------------------------------------------------------
void ofApp::setup(){
...
//added by sena
        ...
        if (sortedType != 6){
            sortedType = 6;
            ofSort(colorNames, compareGreen);
        }
    }
