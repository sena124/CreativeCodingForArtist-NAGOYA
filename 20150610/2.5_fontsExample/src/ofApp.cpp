...
//added by sena
    nicomoji.loadFont("nicomoji.ttf", 14, true, true);
    nicomoji.setLineHeight(18.0f);
    nicomoji.setLetterSpacing(1.037);
//
...
//added by sena
    ofSetColor(29,29,29);
    ofLine(30, 600, ofGetWidth()-4, 600);
    
    ofSetColor(225);
    nicomoji.drawString("Font Example - use keyboard to type", 30, 635);
    
    ofSetColor(245, 58, 135);
    nicomoji.drawString("anti aliased", 155, 692);
    nicomoji.drawString("anti aliased", 155, 795);
    nicomoji.drawString("aliased", 545, 692);
    
    ofSetColor(225);
    nicomoji.drawString("nicomoji 14pt", 30, 692);
    nicomoji.drawString(typeStr, 30, 711);
    
    nicomoji.drawString("nicomoji 14pt", 422, 692);
    ofRect(420, 697, 292, 62);
    ofSetColor(54, 54, 54);
    nicomoji.drawString(typeStr, 422, 711);
